...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'pixelplayer.2424@gmail.com'  # Reemplaza con tu dirección de correo Gmail
EMAIL_HOST_PASSWORD = 'ivftxquvhjvxgywr' # Reemplaza con tu contraseña de "aplicación generada"
